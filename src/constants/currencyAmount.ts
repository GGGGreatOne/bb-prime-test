...
export class CurrencyAmount<T extends Currency> {
	 ...
	 */
	public static fromRawAmount<T extends Currency>(currency: T, amount: string | number | bigint): CurrencyAmount<T> {
	 ...
	 */
	public static fromAmount<T extends Currency>(currency: T, amount: string | number): CurrencyAmount<T> | undefined {
		try {
